...
def get_args():
    ...
    parser.add_argument(
        ...
        action='store_true', 
        default=False, 
        help='val mode for certain ckpt')
    parser.add_argument(
        '--test', 
        action='store_true', 
        default=False, 
    ...
    args.experiment_path = os.path.join('./work_dirs', Path(args.config).stem, Path(args.config).parent.stem, args.exp_name)
    args.tfboard_path = os.path.join('./work_dirs', Path(args.config).stem, Path(args.config).parent.stem,'TFBoard' ,args.exp_name)
